...
import operations_static as op_s
from string_parser import Packed
...
def create_single_tasks():
    # operations_static and functions
    TaskManager.create_single_task(
        func=staticmethod(op_s.add_host),
        name='add_host',
        description='Add ip mapping to host file (ipa, ipb)',
        task_type=TaskType.FRAMEWORK,
    )
    TaskManager.create_single_task(
        func=staticmethod(op_s.ps_uninstall_updates),
        name='ps_uninstall_updates',
        description='Uninstall updates (updates)',
        task_type=TaskType.FRAMEWORK,
    )
    TaskManager.create_single_task(
        func=staticmethod(op_s.ps_hide_updates),
        name='ps_hide_updates',
    ...
    TaskManager.create_single_task(
        func=staticmethod(
            lambda value, open_tag='($', close_tag=')', separator='|':
            Packed(value=value, open_tag=open_tag, close_tag=close_tag, separator=separator).unpacked()
        ),
        name='str_unpack',
        description='Parse and unpack string (value, [op]open_tag, [op]close_tag, [op]separator)',
        task_type=TaskType.FRAMEWORK,
    )
    TaskManager.create_single_task(
        func=Packed.unpack_zip_line,
        name='str_unpack_line',
        description='Parse and unpack string for a line (value, [op]open_tag, [op]close_tag, [op]separator)',
        task_type=TaskType.FRAMEWORK,
    )
    TaskManager.create_single_task(
        func=Packed.unpack_zip_line,
        name='str_unpack_lines',
        description='Parse and unpack string for multiple lines (value, [op]open_tag, [op]close_tag, [op]separator)',
        task_type=TaskType.FRAMEWORK,
    )
    ...
    TaskManager.create_single_task(
        func=op_io.FilesystemOperator.placeholder,
    ...
    TaskManager.create_single_task(
        func=op_io.RegOperator.placeholder,
    ...
    TaskManager.create_single_task(
        ...
        name='reg_list',
        description='List key (path, [op]value)',
        task_type=TaskType.FRAMEWORK,
    )
